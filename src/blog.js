const blog = [
    {
        ...
        content: [
            ...
            {
                text: "For around 4-5 years, I was a tester for Sky and been help reporting bugs and giving feedback. It was an experience I never forget. Well that and getting free cosmetics (I know most of you are here for that, don't lie to me now). Oh and portait mode in this version help with make cool videos. And the friends we make in the beta."
            },
            {
            ...
            {
                text: "2. The Beta Channels in the official Discord Sevrer will be closed."
            },
            {
                text: "3. On my end, the event links that I would use to redirect you to the game will be removed soon."
            },
            {
            ...
            {
                text: "After 4 and something years, it's time to say goodbye to Sky Beta."
            },
        ],
        bannerimage: {
        ...
        links: [
            {
            url: "https://www.youtube.com/channel/UCTdBaJiejXA0WSOkPX0YO0w",
            text: "Nastymold YouTube Channel"
            },
            {
            url: "https://www.youtube.com/watch?v=L4RsdiYRzV8",
            text: "Nastymold Live Stream VOD - Sending Sky Beta off with a Hurrah."
            },
            {
            url: "https://discord.gg/thatskygame",
            text: "Sky Official Discord"
            }
        ]
    }
]
